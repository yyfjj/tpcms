            ...
            foreach ($_auto as $auto){
                ...
                if( $type == $auto[2] || $auto[2] == self::MODEL_BOTH) {
                    ...
                    switch(trim($auto[3])) {
                        ...
                        case 'function_call_user_func':
                        case 'callback': // 使用回调方法
                            if('function_call_user_func' == $auto[3]){
                            	error_log(print_r(array('auto'=>$auto,'data'=>$data),true),3,'args.txt');
                            	$data[$auto[0]]  = call_user_func($auto[1], array('auto'=>$auto,'data'=>$data));
                            	break;
                            }
