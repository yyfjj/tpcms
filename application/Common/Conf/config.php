...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Wangge','Module'),
		...
		'URL_PATHINFO_FETCH'    =>  'ORIG_PATH_INFO,REDIRECT_PATH_INFO', // 用于兼容判断PATH_INFO 参数的SERVER替代变量列表
);
