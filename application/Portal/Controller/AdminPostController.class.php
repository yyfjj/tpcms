...
class AdminPostController extends AdminbaseController {
	...
	public function index(){
		$template =  file_exists("Admin".sp_get_theme_path().MODULE_NAME.'/'.CONTROLLER_NAME.'/index.html') ? CONTROLLER_NAME.':index' : 'Admin@Content:index';
	...
	public function edit(){
		...
		//TMPL_PATH
		$template =  file_exists("Admin".sp_get_theme_path().MODULE_NAME.'/'.CONTROLLER_NAME.'/edit.html') ? CONTROLLER_NAME.':edit' : 'Admin@Content:edit';
		$this->display($template);
	}
	...
	private function _lists($where=array()){
		...
		//显示自分类下的文章 benjamin by 2017-06-19
